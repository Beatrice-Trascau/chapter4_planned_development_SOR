...
## 9.5. H5 presence: ODDS Ration between land-covers ---------------------------
...
# Save to file
write.csv(or_table,
          here("figures", "Table_H5_presence_OddsRatio_by_landcover.csv"),
          row.names = FALSE)

## 9.6. H5 presence: probability of Alien SOR presence by land-cover -----------
...
# Save to file
write.csv(prob_wide,
          here("figures", "Table_H5_presence_probability_by_landcover_wide.csv"),
          row.names = FALSE)
